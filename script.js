    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (shape == 'cube') {
            if (!globalVariables.cubeLoaded) {
                ...
                cube = yield loadObjectFromFile('resources/models/cube/cube.obj');
            ...
            if (!globalVariables.skullLoaded) {
                ...
                skull = yield loadObjectFromFile('resources/models/skull/skull.obj');
            ...
            if (!globalVariables.ballLoaded) {
                ...
                ball = yield loadObjectFromFile('resources/models/ball/ball.obj');
...
function setShape(positions, positionAttributeLocation, drawDimensions, vao) {
...
function setColor(color, colorAttributeLocation, drawDimensions, vao) {
    gl.bindVertexArray(vao);
...
function multiplyMatrices(translation, rotation, scale) {
...
function convertDegreesToRadians(mode, shape, axis, angle) {
    if (shape == 'cube') {
        if (mode == 'set') {
            if (axis == 'x') {
